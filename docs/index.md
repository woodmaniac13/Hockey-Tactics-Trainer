...
| [specifications/scenario-schema-definition.md](specifications/scenario-schema-definition.md) | Full scenario JSON schema: required fields, entity rules, polymorphic region types (tagged circle, rectangle, polygon, lane), semantic wrappers, constraint thresholds, and validation rules. |
